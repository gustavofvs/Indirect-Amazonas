...
function Hero() {
  return (
      <main className='flex flex-col justify-center items-center flex-grow text-center px-4'>
        ...
        /> 
        <h2 className='font-mono text-secondary max-w-4xl text-sm md:text-base lg:text-lg mt-4'>
        ...
        <div className='flex flex-col sm:flex-row gap-4 mt-8'>
          <Link to="/motivacao">
            <GetStartedButton className='bg-ring hover:bg-ring cursor-target w-full sm:w-auto'>
              Ver Motivação Real
            </GetStartedButton>
          </Link>

          <Link to="/gallery">
            <Button variant='ghost' className='border bg-ring/5 h-10 w-full sm:w-auto hover:border border-ring cursor-target'>
              Explorar Realidade
            </Button>
          </Link>
        </div>
